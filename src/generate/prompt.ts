...
- If no changes have user-visible impact, output exactly \`_No notable changes in this release._\` and nothing else. NEVER explain, list, or justify what was dropped.
`
}
